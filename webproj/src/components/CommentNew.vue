...
export default {
    ...
    data(){
        return{
            ...
            showEntity: true,
            komentarisaoObjekat: false,
            ocena:0,
            //pomocna varijabla u koju ce se ucitavati svi komentari o objektu 
            komentari:[],
    ...
    methods : {
        loadComments(){
            dataService.getAllCommentsByObjectId(this.$route.params.id).then(response => {
