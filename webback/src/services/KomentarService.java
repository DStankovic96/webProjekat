...
//		//pregled svih ODOBRENIH komentara ostavljenih na jedan objekat
//		@GET
//		@Path("/{name}")
...
//		}
		...
		//pregled svih NEODOBRENIH komentara ostavljenih na jedan objekat
		@GET
		@Path("/unmoderated/")
		@Produces(MediaType.APPLICATION_JSON)
		public Collection<Komentar> getAllNeodobreniKomentari(){
		
			KomentarDAO dao = (KomentarDAO)ctx.getAttribute("commentDAO");
			return dao.findAllUnmoderatedComments();
		}
		
		@POST
		@Path("/moderated/")
		@Produces(MediaType.APPLICATION_JSON)
		public Komentar sendModeratedComments(Komentar komentar){
			KomentarDAO dao = (KomentarDAO)ctx.getAttribute("commentDAO");
