...
public class ManagerDAO {
	...
	public Collection<Manager> findFreeManagers() {
		System.out.println("TEST SLOBODNI MENADZERI 1");
		loadManagers(contextPath);
		System.out.println("TEST SLOBODNI MENADZERI 2");
		Collection<Manager> tempLista = new ArrayList<Manager>();
		for(Manager m : managers.values()) {
			if(m.getObjekat().equals("")) {
				tempLista.add(m);
				System.out.println("TEST SLOBODNI MENADZERI 3");
			}
		}
